...
<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=00C2FF,0051ff,6a00ff&height=250&section=header&text=Signature%20Theme&fontSize=60&fontAlignY=35&animation=twinkling&fontColor=ffffff" alt="Signature Theme - Premium Glassmorphism CSS UI Framework Banner" width="100%" />


  <img src="https://readme-typing-svg.demolab.com?font=Inter&weight=600&size=20&pause=1000&color=00C2FF&center=true&vCenter=true&width=600&lines=Zero-Dependency+Vanilla+CSS+Framework;Premium+Glassmorphism+UI+Components;Native+Bi-Directional+(RTL%2FLTR)+Support;Cyberpunk+Dark+%26+Ceramic+Light+Modes" alt="Animated text highlighting zero-dependency vanilla CSS framework, premium glassmorphism UI components, and native bi-directional support" />
  ...
  <img src="https://img.shields.io/badge/HTML5-E34F26?style=for-the-badge&logo=html5&logoColor=white" alt="Semantic HTML5 Structure" />
...
* <img src="https://img.shields.io/badge/CSS3-1572B6?style=flat-square&logo=css3&logoColor=white" alt="CSS3" /> **Modern CSS3:** Leveraging `@layer` cascades, CSS Custom Properties (`:root`), Grid/Flexbox layouts, and advanced selectors (`:has`, `:focus-visible`).
* <img src="https://img.shields.io/badge/HTML5-E34F26?style=flat-square&logo=html5&logoColor=white" alt="HTML5" /> **Semantic HTML5:** Deep utilization of native web elements like `<progress>`, `<dialog>` (via custom modals), and semantic structuring (`<main>`, `<aside>`, `<section>`).
* <img src="https://img.shields.io/badge/JavaScript-F7DF1E?style=flat-square&logo=javascript&logoColor=black" alt="Vanilla JavaScript" /> **Vanilla JavaScript:** An ultra-lightweight (under 2KB) scripting layer exclusively for triggering theme toggles, modal states, and ephemeral toast notifications.
...
<div align="center">
  ...
  <img src="screenshot.png" alt="Screen recording demonstrating Signature Theme glassmorphism, responsive grid, and real-time Dark/Light mode switching" width="100%" style="border-radius: 12px; border: 1px solid rgba(255,255,255,0.1);" />
...
```mermaid
graph TD
    %% Core Architecture Flow for Signature Theme
    Doc["HTML Document"] --> Dir{"Document Direction"}
    
    Dir -->|dir=rtl| RTL["Right-to-Left Layout<br>Persian / Arabic"]
    Dir -->|dir=ltr| LTR["Left-to-Right Layout<br>English / Latin"]
    
    Doc --> Theme{"Theme State"}
    Theme -->|Default| Dark["Cyberpunk Dark Mode<br>Background: #050507"]
    Theme -->|body.light-mode| Light["Ceramic Light Mode<br>Background: #F3F5F9"]
    
    CSS[("style.css")] --> Layers["CSS Cascade Layers"]
    Layers --> L1["@layer reset"]
    Layers --> L2["@layer base"]
    Layers --> L3["@layer components"]
    Layers --> L4["@layer utilities"]
...
<div class="card">
    <img src="https://picsum.photos/200/200" alt="Sample dashboard graph representation">
